                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($edus as $edu)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ \Carbon\Carbon::parse($edu->start)->format('d-m-Y') }}
                                                    </td>
                                                    <td>
                                                        {{ \Carbon\Carbon::parse($edu->end)->format('d-m-Y') }}
                                                    </td>
                                                    <td>
                                                        {!! $edu->desc !!}
                                                    </td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control" placeholder="tahun mulai" name="start"
                                        required>
                                </div>
                            </div>
